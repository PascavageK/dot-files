...
vim.keymap.set("n", "'", "<C-w>>")
--Super increase width (space, ')
vim.keymap.set("n", "<leader>'", "8<C-w>>")
--Window decrease width (;)
vim.keymap.set("n", ";", "<C-w><")
--Super decrease width (space, ;)
vim.keymap.set("n", "<leader>;", "8<C-w><")
...
vim.keymap.set("n", "<leader>cc", ":!gcc <C-r>% -o <C-r>%<Delete><Delete>")
